...
app.whenReady().then(async () => {
  ...
  try {
    ...
    assert.equal(await read('document.querySelectorAll(".message-tool-artifact").length'), 1);
    assert.equal(await read('document.querySelector(".message-tool-artifact img")'), null, 'tool images are not automatically promoted into the loop');
