...
assert.match(runtimeWorker, /chromeConnection\.effectiveMode === 'existing'[\s\S]*?'--auto-connect'/);
assert.match(runtimeWorker, /existing_chrome_remote_debugging_unavailable/);
assert.match(runtimeWorker, /DevToolsActivePort/);
assert.match(runtimeWorker, /config\.connectionMode \?\? 'existing'/);
