...
export type McpHostOperation = 'credentials.read' | 'credentials.write' | 'open-url' | 'elicitation' | 'authentication' | 'openai.access-token' | 'automation.prepare-model' | 'automation.changed' | 'network.configuration' | 'network.route';
